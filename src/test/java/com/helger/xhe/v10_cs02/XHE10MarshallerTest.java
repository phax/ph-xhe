...
import com.helger.xhe.v10_cs02.cac.XHE10HeaderType;
import com.helger.xhe.v10_cs02.cac.XHE10PartyIdentificationType;
import com.helger.xhe.v10_cs02.cac.XHE10PartyType;
import com.helger.xhe.v10_cs02.cac.XHE10PayloadContentType;
import com.helger.xhe.v10_cs02.cac.XHE10PayloadType;
import com.helger.xhe.v10_cs02.cac.XHE10PayloadsType;
...
public final class XHE10MarshallerTest
{
  ...
  public void testReadGood ()
  {
    ...
    for (final File aFile : new FileSystemIterator ("src/test/resources/examples/xhe10-cs02/good"))
      if (aFile.isFile ())
  ...
  public void testReadBad ()
  {
    ...
    final XHE10Marshaller aMarshaller = new XHE10Marshaller ();
    for (final File aFile : new FileSystemIterator ("src/test/resources/examples/xhe10-cs02/bad"))
      if (aFile.isFile ())
